...
public class Test121 // extends Object
{
	...
	*/
	public static void main(String[] args)
	{
		...
		// 임의로 생성된 객체.xxx();	//-- 대상 클래스가 갖고 있는 메소드 xxx() 호출
		...
		//--==>> 에러 발생
		//-- 해당 클레스에 action() 라는 메소드가 정의되어 있지 않기 때문에...

		System.out.println(ob.toString());
		//--==>> Test121@15db9742
		//-- 자바가 객체를 구분하기 위해 임의로 부여하는 식별 번호(해시코드)
		//-- to String() 메소드 ← Object 클래스로부터 상속받은 멤버 중 하나

		System.out.println(ob);
		//--==>> Test121@15db9742
		//-- System 안에 print() 메소드가 정의되어 있고, 이 안에 Object 클래스로부터 상속받은 
