...
○ 중첩 클래스의 종류(4가지)
   ...
   2. 내부 클래스(inner class)
	  ...
	  - 내부 멤버 클래스를 외부에서 단독으로 객체를 생성하여 사용할 수 없다.
   ...
   4. 익명 클래스(무명 클래스, anonymous class)
      이름 없는 클래스
...
class Test
{
	...
	int b=20;				// instance 멤버

	// 내부 클래스
	public static class StaticNested		//-- static (1. 탄생시점 2. 공유)
	{
		int c=30;	// 클래스 자체가 satic 이므로 write() 메소드 탄생과 동시에 탄생함
...
public class Test117
{
	public static void main(String[] args)
	{
		...
		//    접근하여 인스턴스를 생성할 수 있도록 아래와 같이처리해야 한다.
