...
○ 특징
   ...
   객체(인스턴스)를 생성할 수 없는 것이다.

   즉, 추상 클래스는 독립적으로 존재할 수 없기 때문에
   (클래스의 존재 목적은 객체를 생성하기 위함인데 추상 클래스는 생성이 안 되니까)
   상속을 위해서만 존재하며
...
abstract class SortInt
{
	...
	// 추상 메소드(abstract)
	protected abstract void sorting(); //-- 정렬에 대한 정의를 따로 하지 않음
...
public class Test110 extends SortInt
{
	...
	*/
	...
	{
		//SortInt ob = new SortInt();  -- 추상 클래스 객체 생성은 불가능함
