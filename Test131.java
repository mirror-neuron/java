...
public class Test131 //extends Object
{
	...
	{
		String s1 = "seoul";			    //-- 문자열 상수 형태로 지정
		String s2 = "seoul";	
		String s3 = new String("seoul");	//-- String 클래스의 생성자 이용	
		...
		//-- Object 클래스가 갖고 있는 equals() : 문자열 비교, 실제로 문자열 값을 비교하는 메소드
		...
		//   가지비 컬렉션의 대상이 되며
		//   "seoul kroea" 상수가 저장된 영역을 
		//   s2 가 다시 참조하게 되었다가...
		//   또 다시 s2가 참조한 "seoul korea" 가 저장된 영역은
		///  『s2 = "korea"』가 수행되는 시점에서
		//   가비지 컬렉션의 대상이 되며
		//   "kroea" 문자열 상수가 새롭게 저장된 영역을
		//   s2가 참조하게 된다.
		//==> ※ String 객체의 내용은 불변이다~!!!
