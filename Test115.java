...
※ 『extends』 VS 『implements』
	...
	추상 클래스 implements 인터페이스
	추상 클래스 implements 인터페이스, 인터페이스

	클래스 implements 인터페이스
	클래스 implements 인터페이스, 인터페이스

	추상 클래스 extends 추상 클래스
	추상 클래스 extends 클래스
...
※ 인터페이스의 멤버 변수인 데이터는
   ...
   인터페이스 안에서 정의된 모든 메소드들을 구현해 주어야 하며
   인터페이스를 구현하는 클래스는 
...
※ 인터페이스의 선언
   ...
   선언 시에 미리 값을 할당해놓아야 한다.
 
※ 인터페이스의 구현
   인터페이스는 클래스를 위한 템플릿이기 때문에,
   사용 가능한 인터페이스가 되기 위해서는
   자바 프로그램에서 인터페이스를 구현해주어야 하는데
