...
/*
1. 공유(클래스명으로 접근이 가능)
2. 탄생시점(클래스를 로딩 시점에 메모리 할당 받음)

// 인스턴스 변수의 특성
- 인스턴스를 통해 변수든 메소드이든 접근이 가능
- 인스턴스 생성 시점에 메모리 할당 받음

// 생성자 특성
- 생성자 내에 생성자 생성 가능하다
- 단, 생성자 내부에서 가장 먼저 호출되어야 한다
*/
...
public class Test092
{
	...
	//	  클래스 메소드(static 메소드)에서는 접근할 수 있다.
	...
	{
		System.out.println("클래스 변수 a : " + a);
		//System.out.println("인스턴스 변수 b : " + b);		//-- 에러 발생(static생성 > 인스턴스 생성)
	}

	public static void main(String[] args)  //-- static 메소드(클래스 메소드)
	{
		...
		//System.out.println("main() → 인스턴스 변수 b : " + Test092.b);	 //-- 에러 발생(non static)
		//System.out.println("main() → 인스턴스 변수 b : " + b);			 //-- 에러 발생(    "     )

		//write();				 //-- 에러 발생(non static)
		//Test092.write();		 //-- 에러 발생(    "     )
