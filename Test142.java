...
※ 정리해놓은 문법~!!! (→ Exception 클래스)
   ...
   - 예외는 프로그램 실행 중 발생할 수 있는
	 ...
	 자바에서 '예외'는 하나의 오브젝트(Object, 객체)이다.

   - 프로그램 실행 중에 "메소드 안"에서 오류(Error)가 발생하게 될 경우,
     메소드는 그 오류에 해당하는 [ 예외 오브젝트 ]를 만들고
...
{											// ① 
	public static void main(String[] args)	// throws IOException
	{
		...
		catch (IOException e)		// 참조변수명 e : 식별자를 붙여 예외가 생겼을 때 불러옴
		{
			// IOException → checked exception
			//-- 메소드를 정희하는 과정에서 throws 한 예외.
